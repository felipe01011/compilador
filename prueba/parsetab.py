...
_lr_productions = [
  ...
  ('statement -> WHILE condition DO statement','statement',4,'p_statement5','analizador_sintactico.py',103),
  ('statement -> empty','statement',1,'p_statementEmpty','analizador_sintactico.py',108),
  ('statementList -> statement','statementList',1,'p_statementList1','analizador_sintactico.py',113),
  ('statementList -> statementList SEMMICOLOM statement','statementList',3,'p_statementList2','analizador_sintactico.py',118),
  ('condition -> ODD expression','condition',2,'p_condition1','analizador_sintactico.py',123),
  ('condition -> expression relation expression','condition',3,'p_condition2','analizador_sintactico.py',128),
  ('relation -> ASSIGN','relation',1,'p_relation1','analizador_sintactico.py',133),
  ('relation -> NE','relation',1,'p_relation2','analizador_sintactico.py',138),
  ('relation -> LT','relation',1,'p_relation3','analizador_sintactico.py',143),
  ('relation -> GT','relation',1,'p_relation4','analizador_sintactico.py',148),
  ('relation -> LTE','relation',1,'p_relation5','analizador_sintactico.py',153),
  ('relation -> GTE','relation',1,'p_relation6','analizador_sintactico.py',158),
  ('expression -> term','expression',1,'p_expression1','analizador_sintactico.py',163),
  ('expression -> addingOperator term','expression',2,'p_expression2','analizador_sintactico.py',168),
  ('expression -> expression addingOperator term','expression',3,'p_expression3','analizador_sintactico.py',173),
  ('addingOperator -> PLUS','addingOperator',1,'p_addingOperator1','analizador_sintactico.py',178),
  ('addingOperator -> MINUS','addingOperator',1,'p_addingOperator2','analizador_sintactico.py',183),
  ('term -> factor','term',1,'p_term1','analizador_sintactico.py',188),
  ('term -> term multiplyingOperator factor','term',3,'p_term2','analizador_sintactico.py',193),
  ('multiplyingOperator -> TIMES','multiplyingOperator',1,'p_multiplyingOperator1','analizador_sintactico.py',198),
  ('multiplyingOperator -> DIVIDE','multiplyingOperator',1,'p_multiplyingOperator2','analizador_sintactico.py',203),
  ('factor -> ID','factor',1,'p_factor1','analizador_sintactico.py',208),
  ('factor -> NUMBER','factor',1,'p_factor2','analizador_sintactico.py',213),
  ('factor -> LPARENT expression RPARENT','factor',3,'p_factor3','analizador_sintactico.py',218),
  ('empty -> <empty>','empty',0,'p_empty','analizador_sintactico.py',223),
]
