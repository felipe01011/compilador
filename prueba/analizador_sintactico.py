#importacion de las galerias necesarias 
...
#Definicion de las funciones con las reglas gramaticales 
def p_program(p):
	'''program : block'''
	print ("program")
...
# Definicion de la ruta para ejecutar el compilador 
...
def traducir(result):
	...
	graphFile.write(str(result.traducir()))
	graphFile.close()
...
result = yacc.parse(chain,debug=1)
traducir(result)
print (result)
